...
public class FragmentBedroomLight extends Fragment implements View.OnClickListener {
...
//        }
    ...
    private void initView(View view) {
        ...
        mRef = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("Bedroom").child("LightIns");
        mRefLight = database.getReference("SmartHome").child(FirebaseAuth.getInstance().getUid()).child("Bedroom")
        ...
        switch (view.getId())
        {
            ...
            case R.id.back_arrow:
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.fragment_host_main, new FragmentBedroom())
                        .commit();
                break;
